 ...
 * @test
 * @bug 8259775
 * @summary test code-gen for VectorReinterpret operation for 256-bit vectors
 * @modules jdk.incubator.vector
 * @run main compiler.vectorapi.VectorReinterpretTest256
 */

public class VectorReinterpretTest256 {
